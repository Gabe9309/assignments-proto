...
type NewsServiceClient interface {
	GetNewsFeed(ctx context.Context, in *NewsRequest, opts ...grpc.CallOption) (*NewsResponse, error)
	ListSections(ctx context.Context, in *ListSectionsRequest, opts ...grpc.CallOption) (*SectionListResponse, error)
}
...
func (c *newsServiceClient) GetNewsFeed(ctx context.Context, in *NewsRequest, opts ...grpc.CallOption) (*NewsResponse, error) {
	out := new(NewsResponse)
	err := c.cc.Invoke(ctx, "/news.NewsService/GetNewsFeed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *newsServiceClient) ListSections(ctx context.Context, in *ListSectionsRequest, opts ...grpc.CallOption) (*SectionListResponse, error) {
	out := new(SectionListResponse)
	err := c.cc.Invoke(ctx, "/news.NewsService/ListSections", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NewsServiceServer interface {
	GetNewsFeed(context.Context, *NewsRequest) (*NewsResponse, error)
	ListSections(context.Context, *ListSectionsRequest) (*SectionListResponse, error)
...
func (UnimplementedNewsServiceServer) GetNewsFeed(context.Context, *NewsRequest) (*NewsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetNewsFeed not implemented")
}
func (UnimplementedNewsServiceServer) ListSections(context.Context, *ListSectionsRequest) (*SectionListResponse, error) {
...
func _NewsService_GetNewsFeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/news.NewsService/GetNewsFeed",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NewsServiceServer).GetNewsFeed(ctx, req.(*NewsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _NewsService_ListSections_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListSectionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NewsServiceServer).ListSections(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/news.NewsService/ListSections",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NewsServiceServer).ListSections(ctx, req.(*ListSectionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NewsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _NewsService_ListSections_Handler,
		},
	},
